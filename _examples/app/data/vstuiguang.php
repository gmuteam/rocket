...
echo file_get_contents(
        ...
        // 'http://hudamin.fe.baidu.com/notes/bin/markdown/list_articles.php?' . $query_string, false, $context
        'http://m.baidu.com/static/video/vstuiguang/vstuiguang.js?' . $query_string, false, $context
    );
